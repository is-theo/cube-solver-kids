...
export const FACE_INSTRUCTION_KR: Record<CubeColor, string> = {
  U: '🌟 흰색이 중앙! (큐브의 위쪽은 파란색이 오게 해줘)',
  R: '🍎 빨간색이 중앙! (큐브의 위쪽은 흰색이 오게 해줘)',
  F: '🌿 초록색이 중앙! (큐브의 위쪽은 흰색이 오게 해줘)',
  D: '🌙 노란색이 중앙! (큐브의 위쪽은 초록색이 오게 해줘)',
  L: '🦊 주황색이 중앙! (큐브의 위쪽은 흰색이 오게 해줘)',
  B: '🌊 파란색이 중앙! (큐브의 위쪽은 흰색이 오게 해줘)',
};
